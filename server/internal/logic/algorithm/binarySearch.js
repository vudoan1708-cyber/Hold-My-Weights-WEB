const halfAnArray = require('../array');
...
module.exports = function binarySearch(array, index) {
  ...
  const indexedLabel = findIndex(rightSide[0], index);

  // 3: Decide To Return an Index or To Perform Recursive Loops
  // indexedLabel = -1 (The Wanted Index is Lower Than The First Index of The Right Side Array)
  if (indexedLabel === -1) return binarySearch(leftSide, index);
